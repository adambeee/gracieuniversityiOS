//
//  ReflexDevelopmentTableViewController.swift
//  GracieUnversityProgressTracker
//
//  Created by Adam Baca on 4/29/17.
...
class ReflexDevelopmentTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return reflexDevelopmentClassArray.count
    }

    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "rdLabelCell", for: indexPath)

        cell.textLabel?.text = reflexDevelopmentClassArray[indexPath.row]
        return cell
    }
