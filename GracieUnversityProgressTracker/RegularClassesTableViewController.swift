//
//  RegularClassesTableViewController.swift
...
class RegularClassesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "rcLabelCell", for: indexPath)

        cell.textLabel?.text = regularClassArray[indexPath.row]
